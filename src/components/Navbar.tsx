...
const Navbar = ({ searchQuery, onSearchChange, onSearch, onClearSearch }: NavbarProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 md:left-64 right-0 h-16 md:h-20 pt-safe px-safe bg-background/80 backdrop-blur-xl border-b border-border z-30 flex items-center justify-between px-4 md:px-8">
      {/* Search Bar */}
